...
public class Api
{
	...
	public native Wallet createWallet(String appVersion, String nodeAddr, String path, String pass, String phrases, boolean restore, int heightForkTest);
	public native Wallet openWallet(String appVersion, String nodeAddr, String path, String pass, int heightForkTest);
