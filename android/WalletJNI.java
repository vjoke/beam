...
public class WalletJNI
{
	public static void main(String[] args)
	{
		...
		{
			wallet = api.openWallet("1.0.0.0", nodeAddr, "test", "123", 199403);

			System.out.println(wallet == null ? "wallet opening error" : "wallet successfully opened");
		}
		else
		{
			wallet = api.createWallet("1.0.0.0", nodeAddr, "test", "123", "garbage;wild;fruit;vicious;jungle;snack;arrange;pink;scorpion;speed;used;frozen;", false, 199403);
